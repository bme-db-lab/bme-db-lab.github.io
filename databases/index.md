...
PPT presentations:
 ...
 - ER: [Material here](ER.pptx)
 - Query optimization: [Material here](optimization2021.pdf)
...
### Instructor
 ...
 - [János Varga](https://www.linkedin.com/in/jvarga84), varga.janos -AT- db.bme.hu
...
Please make sure you have this open at the beginning of each practice.
 ...
 --|--|--
 ER Modeling|Sep. 15|[HERE](practice_er_2022.pdf)
 LECTURE|Sep. 22|
 Relational Queries|Sep. 29|[HERE](practice_rel_2022.pdf)
 Physical Storage|Oct. 13|[HERE](practice_stor.pdf)
 Query Optimization|Oct. 27|[HERE](practice_opti.pdf)
 LECTURE|Nov. 10|
 Transaction Management|Nov. 24|[HERE](practice_tran.pdf)
 Normalization|during lectures|[HERE](practice_norm.pdf)
...
The Team workshop will be in room IE.220. Everyone can participate.
...
Your exercise sheet can be downloaded from [here](oracle_exercises.pdf).
...
The material for the SQL labs (SQL1, SQL2, and SQL3) can be found [here](sql.pdf). The appendix about SQL constraints is [here](EN_Constraint.pdf)
...
The skeleton of the script to be handed in is [here](https://db.bme.hu/~eros/SKELETON.sql), while [here](https://db.bme.hu/r/sql/sql123-beadando-generator.html) is a page that helps you create the XML file if you don’t do it manually. USING THE GENERATOR PAGE IS PREFERRED.

PLEASE NOTE THAT IF YOUR SCRIPT DOES NOT GENERATE A WELL-FORMED XML OUTPUT, YOU WILL FAIL.
...
The solution of the team workshop is [here](workshopsolution.pdf)
...
- November 7th, 14:15-15:45, in room IE.007

## Retakes

- Laboratory retakes will be on December 9th 8:15, in R4D

- The midterm retake will be on December 15th, between 8:15 and 9:45, in IE.220.
