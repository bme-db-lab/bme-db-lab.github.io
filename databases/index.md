...
Lectures are held every Monday in room IE.220. **October 5 is a faculty break, no class that day.**

Tutorial and lab schedule is as follows:

type of class|location|topic|date
--|--|--|--
tutorial|IE.220|ER modeling|september 17
laboratory|building R|Oracle|september 24
tutorial|IE.220|relational data model|october 01
laboratory|building R|SQL 1|october 08
NOTHING|NOWHERE|NOTHING|october 15
laboratory|building R|SQL 2|october 22
tutorial|IE.220|physical storage|october 29
laboratory|building R|SQL 3|november 05
tutorial|QBF.13|optimization|november 12
NOTHING|NOWHERE|NOTHING|november 19
tutorial|QBF.13|normalization|november 26
team workshop|?????|ER modeling|december 03
tutorial|QBF.13|transaction management|december 10
...
PPT presentations:
 ...
 - Normalization: [Material here](normalization.pptx)
...
[Exercise book](exercises.pdf). If you do every single exercise, and discuss your questions with your instructors, your chances of getting a good grade will significantly improve (as decades of experience suggests).
...
Tutorials and laboratories have separate material. See these in the appropriate sections.
...
Tutorials are held on Thursdays, from 16:15 to 17:45 in room QBF.13, according to the Schedule section. You should prepare for these classes, from all preceding lectures.
 
### Instructor

 - Péter Tóth, toth.peter -at- db.bme.hu
 
### Exercise sheets

Make sure you have these open in the beginning of the corresponding tutorial.

[ER Modeling](Practice01.pdf)
[Relational Queries](practice_rel_2022.pdf)
[Physical Storage](practice_stor.pdf)
[Query Optimization](practice_opti.pdf)
[Normalization](practice_norm.pdf)
[Transaction Management](practice_tran.pdf)
...
Lab instructors (name, e-mail, lab group):
 - Dávid Sztahó, sztaho.david -at- vik.bme.hu, c16a-1, room R4C
 - Monakhov Artem, monakhovartem -at- edu.bme.hu, c16a-2, room R4K
 - Elshamy Kareem Ayman Galal Hassan, kelshamy -at- edu.bme.hu, c16a-2, room R4K
 - Dimitrija Krstev, dimitrija.krstev -at- icloud.com, c16a-3, room R4L
 - Serageldin Hussein, husseinserageldin -at- edu.bme.hu, c16a-3, room R4L
...
Each lab is on Thursday, from 16:15 to 17:45, according to the Schedule section.
 
### General information

You should arrive at the lab prepared from the course material (see this below for each separate topic). At the beginning of each lab, an entry test will be written which is necessary for completing the given lab practice. The course material can be found below for each topic, separately.
...
8. Including conceptual errors in your documentation (like including foreign keys in ER diagrams) results in failure of the entire lab.

### Software you will need

 - [Oracle SQL Developer 24.3.1 Win64 with built-in JDK 17](https://www.oracle.com/database/sqldeveloper/technologies/download/)
 - For other platforms, you can download the same version of SQL Developer same site. You’ll need to install the appropriate Java 8 JDK to run this. Attention! It is possible that the newest version on Oracle's website is newer than what we use. However, earlier versions can be found on the website as well, by following the "Previous version" or "Previous release" link.
...
The skeleton of the script to be handed in is [here](https://db.bme.hu/~eros/SKELETON.sql), while [here](https://db.bme.hu/r/sql/sql123-beadando-generator.html) is a page that helps you create the SQL file if you don’t do it manually. 
...
the lecture.
 ...
 [Task sheet here](DBWorkshop2025.pdf)
...
Monday, November 16, 8:15-9:45 location: ?

## Midterm Retake

Monday, November 30, 8:15-9:45 location: ?
