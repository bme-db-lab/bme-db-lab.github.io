...
A beadandó SQL szkript váza, illetve az SQL-1, SQL-2, SQL-3 laborokhoz kapcsolódóan egy beadandó generátor alkalmazás elérhető az [SQL laborok áttekintő lapján](./).
...
Formai követelmények:
 ...
 - Egyértelműen jelölni kell a feladat sorszámával, hogy melyik utasítás melyik feladat megoldása. A feladatsorszámok a feladatlapon találhatók. **Figyelem!** Az SQL-1, az SQL-2 és az SQL-3 laborok feladatsorszámai pontot tartalmaznak.
...
```
 ...
 - Az adatmanipulációs feladatok előtt, tehát az SQL-3 labor megoldásában a szkriptnek ki kell adnia a `set feedback on` utasítást. Utána pedig a `set feedback off` utasítást. Nem adatmanipulációs feladatok előtt nem szabad alkalmazni a `set feedback on` utasítást.
