...
Ezután a Java kódot készítettem el. Ehhez a HelloWorldApp.java fájl HelloWorld metódusában végeztem el a kezdeti módosításokat, ez a fájl 31. sorában található.
``` java
...
A függvény kiírja a megfelelő sztringet.
